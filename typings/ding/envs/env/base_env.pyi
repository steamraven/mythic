...
from typing import Any, Generic, List, NamedTuple, Tuple, TypeVar, TypedDict
from easydict import EasyDict
import numpy as np

class BaseEnvTimestep(NamedTuple):
    obs: Any
    reward: np.ndarray[tuple[()], np.dtype[np.float32]]
    done: bool
    info: dict[str, Any]
...
class ObservationDict(TypedDict, Generic[ObsType]):
    Observation: gym.spaces.Space[ObsType]

class BaseEnv(gym.Env[ObsType, ActType], ABC, metaclass=FinalMeta):
    """
    Overview:
